...
- A real Playwright run against `https://go-alpha.craftmatrix.org/project/default` passed after the control-route fix: zero failed responses, zero console/page errors, and visible native Studio project content plus `Advisor found no issues`.
