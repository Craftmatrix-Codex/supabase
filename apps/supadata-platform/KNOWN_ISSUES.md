...
- Realtime, metadata/admin APIs, functions, and jobs are not implemented yet. Storage now has a partial object API and S3-compatible backend, but bucket metadata, signed URLs, policies, resumable uploads, and exact Storage parity remain.
