...
| Request-scoped project routing and database binding | PARTIAL | Host/header project resolution, strict project database router, REST project claim propagation, and cross-project unit/HTTP tests; API-key-to-project mapping, database provisioning, and full multi-project live isolation remain unimplemented |
